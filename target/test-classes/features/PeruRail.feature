  ...
  Segunda ruta: EXPEDITION (Cusco>Machu Picchu)
    ...
    Esquema del escenario: Compra de boletos de la ruta 1
      ...
      Y verifico las cantidades y los datos ingresados en la compra
        ...
        | <destino> | <ruta> | <tren> |
      Ejemplos:
        | destino | ruta         | tren                             | firstName | lastName | mesCumple | añoCumple | Nacionalidad | documento | docNumero | sexo | numCelular | email                  | confirnEmail            | firstName2 | lastName2 | mesCumple2 | añoCumple2 | Nacionalidad2 | documento2 | docNumero2 | sexo2 | numCelular2 | email2             | confirnEmail2       |
        | Cusco   | Puno > Cusco | Andean Explorer, A Belmond Train | Orlando   | Quispe   | 4         | 1999      | PER          | DNI       | 72251553  | M    | 993969806  | orlandoqf123@gmail.com | orlandoqf123@gmail.com> | Juan       | Rebatta    | 5          | 1999       | PER           | DNI        | 71251553   | M     | 993929806   | juanf123@gmail.com | juanf123@gmail.com> |
